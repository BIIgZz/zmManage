...
public class ZmToolWorldAreaController extends JeecgController<ZmToolWorldArea, IZmToolWorldAreaService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_tool_world_area-分页列表查询")
	@ApiOperation(value="zm_tool_world_area-分页列表查询", notes="zm_tool_world_area-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_tool_world_area-添加")
	@ApiOperation(value="zm_tool_world_area-添加", notes="zm_tool_world_area-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_tool_world_area-编辑")
	@ApiOperation(value="zm_tool_world_area-编辑", notes="zm_tool_world_area-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_tool_world_area-通过id删除")
	@ApiOperation(value="zm_tool_world_area-通过id删除", notes="zm_tool_world_area-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_tool_world_area-批量删除")
	@ApiOperation(value="zm_tool_world_area-批量删除", notes="zm_tool_world_area-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_tool_world_area-通过id查询")
	@ApiOperation(value="zm_tool_world_area-通过id查询", notes="zm_tool_world_area-通过id查询")
