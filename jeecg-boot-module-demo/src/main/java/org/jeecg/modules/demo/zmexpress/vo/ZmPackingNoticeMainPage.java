 ...
 */
@Data
@ApiModel(value="zm_packing_notice_mainPage对象", description="装箱通知书主表")
public class ZmPackingNoticeMainPage {
	...
	@ExcelCollection(name="装箱通知书")
	@ApiModelProperty(value = "装箱通知书")
	private List<ZmPackingNotice> zmPackingNoticeList;
